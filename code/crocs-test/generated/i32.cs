...
namespace torc.lang
{
    public class i32 : WiftObj, IHasI32
    {
        ...
        public i32r r { get { return new i32r(this); } }
        ...
        //public static implicit operator i32r(i32 num) { return new i32r(num); }
        ...
        public static i32 operator +(i32 a, i32 b)
        {
            ...
            return result;
        }public static i32 operator +(i32 a, i8 b)
        {
            var value = i32.GetBackingValue(a) + i8.GetBackingValue(b);
            if (value < i32.MIN) { throw new Exception("underflow!"); }
            if (value > i32.MAX) { throw new Exception("overflow!");  }
            i32 result = (int)value;
            return result;
        }public static i32 operator +(i32 a, i16 b)
        {
            var value = i32.GetBackingValue(a) + i16.GetBackingValue(b);
            if (value < i32.MIN) { throw new Exception("underflow!"); }
            if (value > i32.MAX) { throw new Exception("overflow!");  }
            i32 result = (int)value;
            return result;
        ...
        }public static i64 operator +(i32 a, i64 b)
        {
            ...
            return result;
        }public static i32 operator +(i32 a, u8 b)
        {
            var value = i32.GetBackingValue(a) + u8.GetBackingValue(b);
            if (value < i32.MIN) { throw new Exception("underflow!"); }
            if (value > i32.MAX) { throw new Exception("overflow!");  }
            i32 result = (int)value;
            return result;
        }public static i32 operator +(i32 a, u16 b)
        {
            var value = i32.GetBackingValue(a) + u16.GetBackingValue(b);
            if (value < i32.MIN) { throw new Exception("underflow!"); }
            if (value > i32.MAX) { throw new Exception("overflow!");  }
            i32 result = (int)value;
            return result;
        }public static i64 operator +(i32 a, u32 b)
        {
            var value = i32.GetBackingValue(a) + u32.GetBackingValue(b);
