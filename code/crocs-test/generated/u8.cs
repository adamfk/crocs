...
namespace torc.lang
{
    public class u8 : WiftObj, IHasU8
    {
        ...
        public u8r r { get { return new u8r(this); } }
        ...
        //public static implicit operator u8r(u8 num) { return new u8r(num); }
        ...
        }public static i16 operator +(u8 a, IHasI8 b)
        {
            ...
            return result;
        }public static i16 operator +(u8 a, i8 b)
        {
            var value = u8.GetBackingValue(a) + i8.GetBackingValue(b);
            if (value < i16.MIN) { throw new Exception("underflow!"); }
            if (value > i16.MAX) { throw new Exception("overflow!");  }
            i16 result = (short)value;
            return result;
        ...
        {
            var value = u8.GetBackingValue(a) + i16.GetBackingValue(b);
            if (value < i16.MIN) { throw new Exception("underflow!"); }
            if (value > i16.MAX) { throw new Exception("overflow!");  }
            i16 result = (short)value;
            return result;
        ...
        {
            var value = u8.GetBackingValue(a) + i32.GetBackingValue(b);
        ...
        {
            var value = u8.GetBackingValue(a) + i64.GetBackingValue(b);
