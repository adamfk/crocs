...
namespace torc.lang
{
    public class u16 : WiftObj, IHasU16
    {
        ...
        public u16r r { get { return new u16r(this); } }
        ...
        //public static implicit operator u16r(u16 num) { return new u16r(num); }
        ...
        }public static i32 operator +(u16 a, IHasI16 b)
        {
            ...
            i32 result = (int)value;
            return result;
        }public static i32 operator +(u16 a, i8 b)
        {
            var value = u16.GetBackingValue(a) + i8.GetBackingValue(b);
            if (value < i32.MIN) { throw new Exception("underflow!"); }
            if (value > i32.MAX) { throw new Exception("overflow!");  }
            i32 result = (int)value;
            return result;
        }public static i32 operator +(u16 a, i16 b)
        {
            var value = u16.GetBackingValue(a) + i16.GetBackingValue(b);
            if (value < i32.MIN) { throw new Exception("underflow!"); }
            if (value > i32.MAX) { throw new Exception("overflow!");  }
            i32 result = (int)value;
            return result;
        ...
        {
            var value = u16.GetBackingValue(a) + i32.GetBackingValue(b);
            if (value < i32.MIN) { throw new Exception("underflow!"); }
            if (value > i32.MAX) { throw new Exception("overflow!");  }
            i32 result = (int)value;
            return result;
        ...
        {
            var value = u16.GetBackingValue(a) + i64.GetBackingValue(b);
            
            i64 result = (long)value;
            return result;
        }public static u16 operator +(u16 a, u8 b)
        {
            var value = u16.GetBackingValue(a) + u8.GetBackingValue(b);
            if (value < u16.MIN) { throw new Exception("underflow!"); }
            if (value > u16.MAX) { throw new Exception("overflow!");  }
            u16 result = (ushort)value;
            return result;
