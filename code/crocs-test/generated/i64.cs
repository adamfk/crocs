...
namespace torc.lang
{
    public class i64 : WiftObj, IHasI64
    {
        ...
        public i64r r { get { return new i64r(this); } }
        ...
        //public static implicit operator i64r(i64 num) { return new i64r(num); }
        ...
        public static i64 operator +(i64 a, i64 b)
        {
            ...
            return result;
        }public static i64 operator +(i64 a, i8 b)
        {
            var value = i64.GetBackingValue(a) + i8.GetBackingValue(b);
            
            i64 result = (long)value;
            return result;
        }public static i64 operator +(i64 a, i16 b)
        {
            var value = i64.GetBackingValue(a) + i16.GetBackingValue(b);
            
            i64 result = (long)value;
            return result;
        }public static i64 operator +(i64 a, i32 b)
        {
            var value = i64.GetBackingValue(a) + i32.GetBackingValue(b);
        ...
        }public static i64 operator +(i64 a, i64 b)
        {
            ...
            i64 result = (long)value;
            return result;
        }public static i64 operator +(i64 a, u8 b)
        {
            var value = i64.GetBackingValue(a) + u8.GetBackingValue(b);
            
            i64 result = (long)value;
            return result;
        }public static i64 operator +(i64 a, u16 b)
        {
            var value = i64.GetBackingValue(a) + u16.GetBackingValue(b);
            
            i64 result = (long)value;
            return result;
        }public static i64 operator +(i64 a, u32 b)
        {
            var value = i64.GetBackingValue(a) + u32.GetBackingValue(b);
