...
namespace torc.lang
{
    public class i8 : WiftObj, IHasI8
    {
        ...
        public i8r r { get { return new i8r(this); } }
        ...
        //public static implicit operator i8r(i8 num) { return new i8r(num); }
        ...
        }public static i64 operator +(i8 a, i64 b)
        {
            ...
            return result;
        }public static i16 operator +(i8 a, u8 b)
        {
            var value = i8.GetBackingValue(a) + u8.GetBackingValue(b);
            if (value < i16.MIN) { throw new Exception("underflow!"); }
            if (value > i16.MAX) { throw new Exception("overflow!");  }
            i16 result = (short)value;
            return result;
        }public static i32 operator +(i8 a, u16 b)
        {
            var value = i8.GetBackingValue(a) + u16.GetBackingValue(b);
            if (value < i32.MIN) { throw new Exception("underflow!"); }
            if (value > i32.MAX) { throw new Exception("overflow!");  }
            i32 result = (int)value;
            return result;
        }public static i64 operator +(i8 a, u32 b)
        {
            var value = i8.GetBackingValue(a) + u32.GetBackingValue(b);
