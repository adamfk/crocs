...
namespace crocs_sim
{
    public class TypeInfo
    {
        ...
        /// like i16
        /// </summary>
        public readonly string crocs_name;
        ...
        public TypeInfo(string type_name)
        {
            ...
            crocs_name = "" + sign_char + width;
        }

        public string ToBinary(decimal value)
        {
            string v = crocs_name switch
            {
        ...
        {
            return crocs_name.Equals(other.crocs_name);
        }
    }
}
